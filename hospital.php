        ...
        <div class="row">
            ...
            <div class="col-dm-6">
                ...
                <div class="mt-4 p-5 bg-dark text-white rounded .shadow-3">
                    ...
                    <h4>Enviar resultados</h4>
                    <br><br>
                    <p>Ingrese El nombre del paciente, el examen realizado, el resultado del examen, y el correo del paciente para futura entrega</p>
                    <form method="post">
                        <label for="paciente">Nombre del paciente</label>
                        <input type="text" name="paciente" id="paciente" placeholder="nombre " ></input>
                        <br><br>
                        <label for="TBexamen">Examen realizado</label>
                        <input type="text" name="TBexamen" id="TBexamen" placeholder="Electro Cardio "></input>
                        <br><br>
                        <label for="TBresultado">Resultado del paciente </label>
                        <input type="text" name="TBresultado" id="TBresultado" placeholder="Tumor" ></input>
                        <br><br>
                        <label for="TBcorreo">Correo del paciente </label>
                        <input type="text" name="TBcorreo" id="TBcorreo" placeholder="Ejemplo@gmail.com" ></input>
                        
                        <br><br>
                        <button type="submit" name="RGuardar" class="btn btn-success" id="RGuardar">Guardar</button>
                        <br>
                    </form>
                    <?php
                    ...
                    <a href="Hystoresultados.php">
                    <button type="submit" name="historial" class="btn btn-success" id="historial">Resultados registrados</button>
                    </a>
                </div>
            </div>
       </div>
